    ...
    <footer className="relative bg-[#2C1810] text-[#FDFBF7] pt-24 pb-12 overflow-hidden">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-20">
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            <div className="flex items-center gap-3">
              <Image src="/images/logo.png" alt="chikbrew" width={48} height={48} className="rounded-full" />
              <h3 className="font-serif text-2xl font-black text-[#D4AF37]">chikbrew</h3>
            </div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-4">
              <a href="mailto:chikbrew.in@gmail.com" className="flex items-center gap-3 text-sm hover:text-[#D4AF37] transition-colors text-[#FDFBF7]/70">
                <Mail size={16} /> chikbrew.in@gmail.com
              </a>
        ...
        <motion.div variants={itemVariants} className="border-t border-[#8C5E3C]/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-mono uppercase tracking-[0.2em] text-[#8C5E3C]">
          <p>© {new Date().getFullYear()} chikbrew. All rights reserved.</p>
